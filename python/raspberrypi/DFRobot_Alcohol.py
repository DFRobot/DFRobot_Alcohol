...
""" 
  ...
  @note DFRobot_Alcohol Class infrastructure, implementation of underlying methods
...
ADDRESS_0                 = 0x72           # i2c slave Address
ADDRESS_1                 = 0x73
ADDRESS_2                 = 0x74
ADDRESS_3                 = 0x75
...
AUTO_READ_DATA            = 0x00           # auto read alcohol data
PASSIVE_READ_DATA         = 0x01           # passive read alcohol data

MODE_REGISTER             = 0x03           # mode register
SET_PASSIVE_REGISTER      = 0x04           # read alcohol data register

AUTO_DATA_HIGE_REGISTER   = 0x09           # auto data high eight bits
AUTO_DATA_LOW_REGISTER    = 0x0A           # auto data Low  eight bits

PASS_DATA_HIGE_REGISTER   = 0x0B           # auto data high eight bits
PASS_DATA_LOW_REGISTER    = 0x0C           # auto data Low  eight bits
